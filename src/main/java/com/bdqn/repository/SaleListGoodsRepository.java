...
public interface SaleListGoodsRepository
		extends JpaRepository<SaleListGoods, Integer>, JpaSpecificationExecutor<SaleListGoods> {
	/**
	 * @param saleListId
	 * @return 根据销售单id查询所有销售单商品
	 */
