...
public class PurchaseList implements Serializable{
	...
	@Transient
	private List<PurchaseListGoods> purchaseListGoods=null;//采购单进货商品集合
	/**
	 * 2.时间：
	...
	public List<PurchaseListGoods> getPurchaseListGoods() {
		return purchaseListGoods;
	}

	public void setPurchaseListGoods(List<PurchaseListGoods> purchaseListGoods) {
		this.purchaseListGoods = purchaseListGoods;
	}
