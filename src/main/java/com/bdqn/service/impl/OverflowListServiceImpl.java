...
import com.bdqn.entity.OverflowList;
...
import com.bdqn.repository.OverflowListRepository;
import com.bdqn.repository.GoodsRepository;
import com.bdqn.repository.GoodsTypeRepository;
import com.bdqn.service.OverflowListService;
...
public class OverflowListServiceImpl implements OverflowListService{
	...
	public void save(OverflowList overflowList, List<OverflowListGoods> overflowListGoodsList) {
		for(OverflowListGoods overflowListGoods:overflowListGoodsList){
			...
			overflowListGoods.setOverflowList(overflowList); // 设置商品报损单
		...
		overflowListRepository.save(overflowList); // 保存商品报损单
	}
