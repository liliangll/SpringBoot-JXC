...
public class GoodsTypeAdminController {
	 ...
	 */
	@RequestMapping("/save")
	@RequiresPermissions(value= {"商品管理","进货入库","退货出库","销售出库","客户退货","商品报损","商品报溢","商品采购统计","商品销售统计"},logical=Logical.OR)
	...
	@RequiresPermissions(value= {"商品管理","进货入库","退货出库","销售出库","客户退货","商品报损","商品报溢","商品采购统计","商品销售统计"},logical=Logical.OR)public Map<String,Object> delete(Integer id)throws Exception{
		Map<String,Object> resultMap=new HashMap<>();
	...
	@RequiresPermissions(value= {"商品管理","进货入库","退货出库","销售出库","客户退货","商品报损","商品报溢","商品采购统计","商品销售统计"},logical=Logical.OR)public String loadTreeInfo()throws Exception{
